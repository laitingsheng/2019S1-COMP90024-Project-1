...
g++ -std=c++17 -I./main/include -lboost_timer -lboost_iostreams -DSINGLE_THREAD -O3 -o bin-st/main main/main.cpp bin-common/grid.o bin-common/processor.o bin-st/processor_st.o
...
g++ -std=c++17 -I./main/include -lboost_timer -lboost_iostreams -O3 -o bin-st/main main/main.cpp bin-common/grid.o bin-common/processor.o bin-common/processor_m.o bin-mt/processor_mt.o
...
g++ -std=c++17 -I./main/include -lboost_timer -lboost_iostreams -O3 -o bin-st/main main/main.cpp bin-common/grid.o bin-common/processor.o bin-common/processor_m.o bin-mn/processor_mn.o
